...
/// @DnDArgument : "funcName" "secret_dooring"
function secret_dooring() 
{
	...
	repeat(_dis_x)
	{
		...
		/// @DnDArgument : "object" "secret_door"
		/// @DnDArgument : "not" "1"
		/// @DnDSaveInfo : "object" "secret_door"
		var l5343E3B2_0 = instance_place(x + sign(_tx - x), y + 0, [secret_door]);
		if (!(l5343E3B2_0 > 0))
		{
			/// @DnDAction : YoYo Games.Common.Variable
			/// @DnDVersion : 1
	...
	repeat(_dis_y)
	{
		...
		/// @DnDArgument : "y_relative" "1"
		/// @DnDArgument : "object" "puertin2"
		/// @DnDArgument : "not" "1"
		/// @DnDSaveInfo : "object" "puertin2"
		var l76944462_0 = instance_place(x + 0, y + sign(_ty - y), [puertin2]);
		if (!(l76944462_0 > 0))
		{
			/// @DnDAction : YoYo Games.Common.Variable
			/// @DnDVersion : 1
